                    ...
                    <div className="dialog-content">
                        <figure>
                            ...
                            <button type="button" onClick={closeModal}>
                                <Image src={ICONS.close} width={20} height={20} alt='close' className='' />
                            </button>
                        </figure>
                        <section>
                            {
                        ...
                        <div className='record-box'>
                            {
                                !isRecording && !recordedVideoUrl && (
                                    ...
                                    >
                                        <Image src={ICONS.record} width={16} height={16} alt='start' className='' />
                                        Record
                                    </button>
                                )
                            }

                            {
                                isRecording && (
                                    ...
                                    >
                                        <Image src={ICONS.record} width={16} height={16} alt='record-stop' className='' />
                                        Stop Recording
                                    </button>
                                )
                            }
                                ...
                                recordedVideoUrl && (
                                    <>
                                        ...
                                        <button onClick={goToUpload}>
                                            <Image src={ICONS.upload} width={16} height={16} alt='upload' className='record-upload' />
                                            Continue to Upload
                                        </button>
                                    </>
                                )
